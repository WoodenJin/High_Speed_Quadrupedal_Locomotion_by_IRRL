...
__ENVIRONMENT_PATH__ = os.path.dirname(os.path.realpath(
    __file__)) + "/flex_gym/env/env/BlackPanther_55"
...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        cmake_args.append(
            '-DRSG_ENVIRONMENT_INCLUDE_PATH=' + __ENVIRONMENT_PATH__)
...
setup(
    ...
    description='FlexibleRobotGym',
    long_description='',
    ext_modules=[CMakeExtension('_flexible_robot')],
